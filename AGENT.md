...
- **High-Altitude Hypoxia & Plateau Adaptation** (`DISC_HIGH_ALTITUDE`): [`agent_notes/high_altitude_AGENT.md`](agent_notes/high_altitude_AGENT.md)
- **Loss of UCP1 & Brown Adipose Thermogenesis** (`DISC_LOSS_UCP1_THERMOGENESIS`): [`agent_notes/loss_ucp1_thermogenesis_AGENT.md`](agent_notes/loss_ucp1_thermogenesis_AGENT.md)
- **Loss of Ascorbic Acid Synthesis (Dietary Vitamin C Dependence)** (`DISC_LOSS_GULO_VITAMINC`): [`agent_notes/loss_gulo_vitaminc_AGENT.md`](agent_notes/loss_gulo_vitaminc_AGENT.md)
- **Loss of Tooth Enamel & Edentulism** (`DISC_ENAMEL_LOSS_EDENTULISM`): [`agent_notes/enamel_loss_edentulism_AGENT.md`](agent_notes/enamel_loss_edentulism_AGENT.md)
- **Extreme Desert Aridity & Renal Water Conservation** (`DISC_DESERT_OSMOREGULATION`): [`agent_notes/desert_osmoregulation_AGENT.md`](agent_notes/desert_osmoregulation_AGENT.md)
- **Peto's Paradox & Extreme Cancer Resistance** (`DISC_PETO_PARADOX_CANCER_RESISTANCE`): [`agent_notes/peto_paradox_cancer_AGENT.md`](agent_notes/peto_paradox_cancer_AGENT.md)
